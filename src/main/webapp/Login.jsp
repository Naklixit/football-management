...
<form action="/web/LoginServlet" method="post">
   ...
   <a href="https://accounts.google.com/o/oauth2/auth?
	scope=email&redirect_uri=http://localhost:8081/web/LoginGoogleServlet&
	response_type=code&client_id=418269843316-7v49mfvht07b4hgjq7sttdbrsehvfih3.apps.googleusercontent.com
